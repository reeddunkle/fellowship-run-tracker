...
import { getDungeonLevelFromAbsoluteDungeonLevel } from "@/services/fellowship/validation/fellowship-common.ts";
import { type FellowshipEvent } from "@/services/fellowship/validation/fellowship-event-schema.ts";
import { type FellowshipLogsConvertibleEvent } from "@/services/fellowship-logs/validation/fellowship-logs-event-schema.ts";
...
export function convertFellowshipLogsEvent({
  actors,
  dungeonStartEvent,
  event,
  reportStartTime,
