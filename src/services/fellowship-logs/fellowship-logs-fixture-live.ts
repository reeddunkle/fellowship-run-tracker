...
import { getFellowshipLogsReportFixtureDirectory } from "@/services/fellowship-logs/fellowship-logs-fixture-paths.ts";
import {
...
import { makeFellowshipLogsGraphQLResponseSchema } from "@/services/fellowship-logs/validation/fellowship-logs-graphql-schema.ts";
...
export function makeFellowshipLogsFixtureLive({
  fixtureDirectory,
  ...
  return Layer.effect(
    ...
    E.gen(function* () {
      ...
      const getReportPagePaths = E.fn(
        "FellowshipLogsFixture.getReportPagePaths",
      ...
      const getDungeonRunMetadata: FellowshipLogsService["getDungeonRunMetadata"] =
        E.fn("FellowshipLogsFixture.getDungeonRunMetadata")(
          function* (options) {
