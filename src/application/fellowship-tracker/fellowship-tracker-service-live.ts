...
import { makeLocalLogDungeonRunPersistence } from "@/application/dungeon-run-processing/local-log-dungeon-run-persistence.ts";
...
const makeFellowshipTrackerLive = E.gen(function* () {
...
export const FellowshipTrackerLive = Layer.effect(
  FellowshipTracker,
  makeFellowshipTrackerLive,
);
