...
import {
  ...
  type FellowshipLogsDungeonRunDAOShape,
} from "@/db/fellowship-logs-dungeon-run/fellowship-logs-dungeon-run-dao.ts";
import { FellowshipLogsImportedDungeonRunRowSchema } from "@/db/fellowship-logs-dungeon-run/fellowship-logs-imported-dungeon-run-row-schema.ts";
import { FellowshipLogsDungeonRunModel } from "@/db/models/fellowship-logs-dungeon-run-model.ts";
import { FellowshipLogsDungeonRunDAOError } from "@/errors/fellowship-logs-dungeon-run-dao-error.ts";
...
export const FellowshipLogsDungeonRunDAOLive = Layer.effect(
  FellowshipLogsDungeonRunDAO,
  make,
);
