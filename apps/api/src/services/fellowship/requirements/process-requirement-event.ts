...
} from "@frt/api/services/fellowship/configurations/analyze-milestone-progress.ts";
import {
...
import { getElapsedMilliseconds } from "@frt/api/util/get-elapsed-milliseconds.ts";
import {
  type CompiledConfiguration,
  type RequirementReference,
} from "@frt/shared/fellowship/configurations/configuration-types.ts";
import { type RequirementLookup } from "@frt/shared/fellowship/requirements/requirement-lookup.ts";
