...
import { AppSettingsModel } from "@frt/db/models/app-settings-model.ts";

import { type AppSettingsDAOShape } from "./app-settings-dao.ts";
...
export const makeAppSettingsDAO = E.gen(function* () {
