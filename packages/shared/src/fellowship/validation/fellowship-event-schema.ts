...
import { UnitDestroyedEventFromLogSchema } from "@frt/shared/fellowship/validation/events/unit-destroyed.ts";
...
export const fellowshipEventSchemas = {
  ...
  [FELLOWSHIP_EVENT.UNIT_DESTROYED]: UnitDestroyedEventFromLogSchema,
